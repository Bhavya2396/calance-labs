    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto">
            ...
            >
              <a
                ...
                className="flex items-center gap-3 px-6 py-4 bg-white text-black text-sm font-medium 
                           tracking-wider hover:bg-white/90 transition-all duration-300"
              >
              ...
              <button
                ...
                className="px-6 py-4 border border-white/30 text-white text-sm font-medium 
                           tracking-wider hover:bg-white/10 transition-all duration-300"
              >
                GET AI BLUEPRINT
              </button>
            </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4"
        >
