  ...
  return (
    <>
      ...
      <div className="relative">
        {/* Controls - high z-index and pointer-events-auto to ensure clickability */}
        <div className="absolute top-2 right-2 z-50 flex gap-1 pointer-events-auto">
          <button
            ...
            className="p-2 bg-black/70 hover:bg-black/90 rounded text-white/80 hover:text-white transition-colors border border-white/10 shadow-lg"
            title="Zoom Out"
          >
          ...
          <span className="px-3 py-2 bg-black/70 rounded text-white/60 text-xs font-medium border border-white/10">
            {Math.round(zoom * 100)}%
          </span>
          <button
            onClick={(e) => {
          ...
          <button
            ...
            className="p-2 bg-black/70 hover:bg-black/90 rounded text-white/80 hover:text-white transition-colors border border-white/10 shadow-lg ml-1"
            title="Fullscreen"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Diagram container */}
        <div
          className="h-[280px] overflow-hidden bg-black/30 border border-white/5 rounded-lg cursor-grab active:cursor-grabbing relative"
